...
fn padding_constructor_with_text() {
    let resultant_array1 = SHA1Padding::new(ABC_L);
    ...
    let resultant_array2 = SHA1Padding::new(ABC_U);
    ...
    let resultant_array3 = SHA1Padding::new(QUICK_FOX);
    ...
    let resultant_array4 = SHA1Padding::new(HEIKE_MONOGATARI);
    let expected_array4 = [
...
fn create_dword_from_padding() {
    let dwords1 = SHA1Padding::new(QUICK_FOX).to_d_words();
    ...
    let dwords2 = SHA1Padding::new(HEIKE_MONOGATARI).to_d_words();
