...
pub struct Sha512_224Hasher {
    pub(crate) size: u128,
    pub(crate) state: Sha512_224State,
    pub(crate) padding: [u8; Self::U8_PAD_SIZE as usize],
}
use internal_hasher::{BlockHasher};
impl BlockHasher<u64, u128> for Sha512_224Hasher {
...
impl HasherContext<u64, u128> for Sha512_224Hasher {
