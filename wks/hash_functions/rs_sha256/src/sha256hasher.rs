...
impl Sha256Hasher {
    ...
    pub(crate) fn hash_block(&mut self) {
        ...
        Sha256Comp(a, b, c, &mut d, e, f, g, &mut h).rnd(w[0], U32Word::K00);
        Sha256Comp(h, a, b, &mut c, d, e, f, &mut g).rnd(w[1], U32Word::K01);
        Sha256Comp(g, h, a, &mut b, c, d, e, &mut f).rnd(w[2], U32Word::K02);
        Sha256Comp(f, g, h, &mut a, b, c, d, &mut e).rnd(w[3], U32Word::K03);
        Sha256Comp(e, f, g, &mut h, a, b, c, &mut d).rnd(w[4], U32Word::K04);
        Sha256Comp(d, e, f, &mut g, h, a, b, &mut c).rnd(w[5], U32Word::K05);
        Sha256Comp(c, d, e, &mut f, g, h, a, &mut b).rnd(w[6], U32Word::K06);
        Sha256Comp(b, c, d, &mut e, f, g, h, &mut a).rnd(w[7], U32Word::K07);
        Sha256Comp(a, b, c, &mut d, e, f, g, &mut h).rnd(w[8], U32Word::K08);
        Sha256Comp(h, a, b, &mut c, d, e, f, &mut g).rnd(w[9], U32Word::K09);
        Sha256Comp(g, h, a, &mut b, c, d, e, &mut f).rnd(w[10], U32Word::K10);
        Sha256Comp(f, g, h, &mut a, b, c, d, &mut e).rnd(w[11], U32Word::K11);
        Sha256Comp(e, f, g, &mut h, a, b, c, &mut d).rnd(w[12], U32Word::K12);
        Sha256Comp(d, e, f, &mut g, h, a, b, &mut c).rnd(w[13], U32Word::K13);
        Sha256Comp(c, d, e, &mut f, g, h, a, &mut b).rnd(w[14], U32Word::K14);
        Sha256Comp(b, c, d, &mut e, f, g, h, &mut a).rnd(w[15], U32Word::K15);
        Sha256Comp(a, b, c, &mut d, e, f, g, &mut h).rnd(w[16], U32Word::K16);
        Sha256Comp(h, a, b, &mut c, d, e, f, &mut g).rnd(w[17], U32Word::K17);
        Sha256Comp(g, h, a, &mut b, c, d, e, &mut f).rnd(w[18], U32Word::K18);
        Sha256Comp(f, g, h, &mut a, b, c, d, &mut e).rnd(w[19], U32Word::K19);
        Sha256Comp(e, f, g, &mut h, a, b, c, &mut d).rnd(w[20], U32Word::K20);
        Sha256Comp(d, e, f, &mut g, h, a, b, &mut c).rnd(w[21], U32Word::K21);
        Sha256Comp(c, d, e, &mut f, g, h, a, &mut b).rnd(w[22], U32Word::K22);
        Sha256Comp(b, c, d, &mut e, f, g, h, &mut a).rnd(w[23], U32Word::K23);
        Sha256Comp(a, b, c, &mut d, e, f, g, &mut h).rnd(w[24], U32Word::K24);
        Sha256Comp(h, a, b, &mut c, d, e, f, &mut g).rnd(w[25], U32Word::K25);
        Sha256Comp(g, h, a, &mut b, c, d, e, &mut f).rnd(w[26], U32Word::K26);
        Sha256Comp(f, g, h, &mut a, b, c, d, &mut e).rnd(w[27], U32Word::K27);
        Sha256Comp(e, f, g, &mut h, a, b, c, &mut d).rnd(w[28], U32Word::K28);
        Sha256Comp(d, e, f, &mut g, h, a, b, &mut c).rnd(w[29], U32Word::K29);
        Sha256Comp(c, d, e, &mut f, g, h, a, &mut b).rnd(w[30], U32Word::K30);
        Sha256Comp(b, c, d, &mut e, f, g, h, &mut a).rnd(w[31], U32Word::K31);
        Sha256Comp(a, b, c, &mut d, e, f, g, &mut h).rnd(w[32], U32Word::K32);
        Sha256Comp(h, a, b, &mut c, d, e, f, &mut g).rnd(w[33], U32Word::K33);
        Sha256Comp(g, h, a, &mut b, c, d, e, &mut f).rnd(w[34], U32Word::K34);
        Sha256Comp(f, g, h, &mut a, b, c, d, &mut e).rnd(w[35], U32Word::K35);
        Sha256Comp(e, f, g, &mut h, a, b, c, &mut d).rnd(w[36], U32Word::K36);
        Sha256Comp(d, e, f, &mut g, h, a, b, &mut c).rnd(w[37], U32Word::K37);
        Sha256Comp(c, d, e, &mut f, g, h, a, &mut b).rnd(w[38], U32Word::K38);
        Sha256Comp(b, c, d, &mut e, f, g, h, &mut a).rnd(w[39], U32Word::K39);
        Sha256Comp(a, b, c, &mut d, e, f, g, &mut h).rnd(w[40], U32Word::K40);
        Sha256Comp(h, a, b, &mut c, d, e, f, &mut g).rnd(w[41], U32Word::K41);
        Sha256Comp(g, h, a, &mut b, c, d, e, &mut f).rnd(w[42], U32Word::K42);
        Sha256Comp(f, g, h, &mut a, b, c, d, &mut e).rnd(w[43], U32Word::K43);
        Sha256Comp(e, f, g, &mut h, a, b, c, &mut d).rnd(w[44], U32Word::K44);
        Sha256Comp(d, e, f, &mut g, h, a, b, &mut c).rnd(w[45], U32Word::K45);
        Sha256Comp(c, d, e, &mut f, g, h, a, &mut b).rnd(w[46], U32Word::K46);
        Sha256Comp(b, c, d, &mut e, f, g, h, &mut a).rnd(w[47], U32Word::K47);
        Sha256Comp(a, b, c, &mut d, e, f, g, &mut h).rnd(w[48], U32Word::K48);
        Sha256Comp(h, a, b, &mut c, d, e, f, &mut g).rnd(w[49], U32Word::K49);
        Sha256Comp(g, h, a, &mut b, c, d, e, &mut f).rnd(w[50], U32Word::K50);
        Sha256Comp(f, g, h, &mut a, b, c, d, &mut e).rnd(w[51], U32Word::K51);
        Sha256Comp(e, f, g, &mut h, a, b, c, &mut d).rnd(w[52], U32Word::K52);
        Sha256Comp(d, e, f, &mut g, h, a, b, &mut c).rnd(w[53], U32Word::K53);
        Sha256Comp(c, d, e, &mut f, g, h, a, &mut b).rnd(w[54], U32Word::K54);
        Sha256Comp(b, c, d, &mut e, f, g, h, &mut a).rnd(w[55], U32Word::K55);
        Sha256Comp(a, b, c, &mut d, e, f, g, &mut h).rnd(w[56], U32Word::K56);
        Sha256Comp(h, a, b, &mut c, d, e, f, &mut g).rnd(w[57], U32Word::K57);
        Sha256Comp(g, h, a, &mut b, c, d, e, &mut f).rnd(w[58], U32Word::K58);
        Sha256Comp(f, g, h, &mut a, b, c, d, &mut e).rnd(w[59], U32Word::K59);
        Sha256Comp(e, f, g, &mut h, a, b, c, &mut d).rnd(w[60], U32Word::K60);
        Sha256Comp(d, e, f, &mut g, h, a, b, &mut c).rnd(w[61], U32Word::K61);
        Sha256Comp(c, d, e, &mut f, g, h, a, &mut b).rnd(w[62], U32Word::K62);
        Sha256Comp(b, c, d, &mut e, f, g, h, &mut a).rnd(w[63], U32Word::K63);
