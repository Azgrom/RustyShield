...
fn sha224_empty_string_prefix_collision_resiliency() {
    ...
    assert_eq!(format!("{result:02x}"), "d14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42f")
}
...
fn sha224_quick_fox_consistency() {
    ...
    assert_eq!(format!("{result:02x}"), "730e109bd7a8a32b1cb9d9a09aa2325d2430587ddbc0c38bad911525");
}
...
fn sha224_appending_dot_quick_fox_consistency() {
    ...
    let result = HasherContext::finish(&mut sha256hasher);
    assert_eq!(format!("{result:02x}"), "619cba8e8e05826e9b8c519c0a5c68f4fb653e8a3d8aa04bb2c8cd4c");
}
