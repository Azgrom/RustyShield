...
impl From<&[u8; 128]> for HasherWords<u64> {
    fn from(value: &[u8; 128]) -> Self {
        Self([
            ...
            U64W::from([
                value[56], value[57], value[58], value[59], value[60], value[61], value[62], value[63],
            ]),
            U64W::from([
                value[64], value[65], value[66], value[67], value[68], value[69], value[70], value[71],
            ]),
            U64W::from([
                value[72], value[73], value[74], value[75], value[76], value[77], value[78], value[79],
            ]),
            U64W::from([
                value[80], value[81], value[82], value[83], value[84], value[85], value[86], value[87],
            ]),
            U64W::from([
                value[88], value[89], value[90], value[91], value[92], value[93], value[94], value[95],
            ]),
            U64W::from([
                value[96], value[97], value[98], value[99], value[100], value[101], value[102], value[103],
            ]),
            U64W::from([
